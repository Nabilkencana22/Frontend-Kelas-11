...
export default function FormBill({ services, customers }: Props) {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            setError(error.message || "An error occurred while adding the bill.");
        } finally {
            setLoading(false);
        }
    }
    ...
    return (
        <div className="w-full max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg">
            <h2 className="text-xl font-semibold mb-6 text-gray-800">Add New Bill</h2>
